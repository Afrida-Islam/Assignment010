...
// // Course Card Component (Based on user's JSX design, adapted for single-file functionality)
...
//   // Placeholder image if link fails or is missing
...
//   // --- Firestore Data Fetching (Filtered by Enrollment) ---
//   useEffect(() => {
//     if (!db || !userId) return;

//     const collectionPath = `/artifacts/${appId}/public/data/courses`;
//     const coursesRef = collection(db, collectionPath);

//     // Filter courses where the 'enrolled_users' array contains the current user's UID
//     // Note: 'enrolled_users' is a hypothetical array field we assume exists for this demo.
//     const q = query(
//       coursesRef,
//       where("enrolled_users", "array-contains", userId)
//     );

//     console.log(`Subscribing to enrolled courses for user: ${userId}`);

//     // Real-time listener for user-specific courses
...
//       // Replace window.confirm with a console message for Iframe environment
//       console.log(
...
//       // 1. Get ALL courses (or a random selection)
...
//         await setDoc(newDocRef, mockCourse);
//         // Re-fetch the list to include the new course
//         console.log(
...
//       // 3. Enroll the user using arrayUnion
